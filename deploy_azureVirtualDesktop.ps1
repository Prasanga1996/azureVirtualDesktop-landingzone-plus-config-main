...
$module1Path = "D:\AB Technologies\AB-Total\azureVirtualDesktop\modules\landing_zone"
$module2Path = "D:\AB Technologies\AB-Total\azureVirtualDesktop\modules\azure_virtual_desktop"

# Move to the first Terraform module directory
Set-Location -Path $module1Path
...
# Define the path to the second Terraform module directory
# Move to the Terraform working directory (replace with your actual Terraform project directory)
Set-Location -Path $module2Path
